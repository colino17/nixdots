...
############
  boot = {
    ...
    kernelParams = [ "mitigations=off" "amd_iommu=on" "default_hugepagesz=1G" "hugepagesz=1G" "hugepages=16" "isolcpus=6-11,18-23" "nohz_full=6-11,18-23" "rcu_nocbs=6-11,18-23" ];
